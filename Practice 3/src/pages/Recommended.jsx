...
const Recommended = () => {
    const recommended = [
        ...
        ...schoolMerch.slice(0, 3).map(i => ({ ...i, section: 'school-merch'}),)
    ];
    ...
    return (
        <div>
            <HeroBanner
                ...
                subtitle="Explore our latest collection of high-quality uniforms and officially branded school merchandise, designed for comfort, style, and school spirit!"
                ctaText="Shop Now"
